...
public class RequestUser {
    ...
    public RequestUser(String username, String email, String password, String fullName, String phone, String phoneCode, String country, int verCode) {
    ...
    public RequestUser(String user_id) {
